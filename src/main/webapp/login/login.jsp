    ...
    <script>
        $(function () {
            ...
            $.extend($.validator().messages,{
                required:"必填字段",
                min:$.validator.format("请输入不小于4的数值")
            })
        });
    </script>
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/Admin/login" method="post" class="login-form" id="loginForm">
                            <span style="color:red;font-size: 21px;margin-left: 45px;">${sessionScope.mess}</span>
                            <span id="msgDiv"></span>
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${pageContext.request.contextPath}/Admin/ImageAction">
